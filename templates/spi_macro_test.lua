...
function SpiFlashMacroTest:_init(tLog)
  ...
  self.atMacroTokens = {
    SMC_RECEIVE  = XX_SMC_RECEIVE_XX,
    SMC_SEND     = XX_SMC_SEND_XX,
    SMC_IDLE     = XX_SMC_IDLE_XX,
    SMC_DUMMY    = XX_SMC_DUMMY_XX,
    SMC_JUMP     = XX_SMC_JUMP_XX,
    SMC_CHTR     = XX_SMC_CHTR_XX,
    SMC_CMP      = XX_SMC_CMP_XX,
    SMC_MASK     = XX_SMC_MASK_XX,
    SMC_MODE     = XX_SMC_MODE_XX,
    SMC_ADR      = XX_SMC_ADR_XX,
    SMC_FAIL     = XX_SMC_FAIL_XX,
    SMC_CS       = XX_SMC_CS_MODE_XX,

    SMCS_FALSE    = XX_SMCS_FALSE_XX,
    SMCS_TRUE     = XX_SMCS_TRUE_XX,

    SPI_MODE0    = XX_SPI_MODE0_XX,
    SPI_MODE1    = XX_SPI_MODE1_XX,
    SPI_MODE2    = XX_SPI_MODE2_XX,
    SPI_MODE3    = XX_SPI_MODE3_XX,

    SPI_BUS_WIDTH_1BIT = XX_SPI_BUS_WIDTH_1BIT_XX,
    SPI_BUS_WIDTH_2BIT = XX_SPI_BUS_WIDTH_2BIT_XX,
    SPI_BUS_WIDTH_4BIT = XX_SPI_BUS_WIDTH_4BIT_XX,

    SPI_MACRO_CHANGE_TRANSPORT_FIFO       = XX_SPI_MACRO_CHANGE_TRANSPORT_FIFO_XX,
    SPI_MACRO_CHANGE_TRANSPORT_ROM        = XX_SPI_MACRO_CHANGE_TRANSPORT_ROM_XX,

    SPI_MACRO_CONDITION_Always    = XX_SPI_MACRO_CONDITION_Always_XX,
    SPI_MACRO_CONDITION_Equal     = XX_SPI_MACRO_CONDITION_Equal_XX,
    SPI_MACRO_CONDITION_NotEqual  = XX_SPI_MACRO_CONDITION_NotEqual_XX,
    SPI_MACRO_CONDITION_Zero      = XX_SPI_MACRO_CONDITION_Zero_XX,
    SPI_MACRO_CONDITION_NotZero   = XX_SPI_MACRO_CONDITION_NotZero_XX,

    MSK_SQI_CFG_IDLE_IO1_OE         = XX_MSK_SQI_CFG_IDLE_IO1_OE_XX,
    SRT_SQI_CFG_IDLE_IO1_OE         = XX_SRT_SQI_CFG_IDLE_IO1_OE_XX,
    MSK_SQI_CFG_IDLE_IO1_OUT        = XX_MSK_SQI_CFG_IDLE_IO1_OUT_XX,
    SRT_SQI_CFG_IDLE_IO1_OUT        = XX_SRT_SQI_CFG_IDLE_IO1_OUT_XX,
    MSK_SQI_CFG_IDLE_IO2_OE         = XX_MSK_SQI_CFG_IDLE_IO2_OE_XX,
    SRT_SQI_CFG_IDLE_IO2_OE         = XX_SRT_SQI_CFG_IDLE_IO2_OE_XX,
    MSK_SQI_CFG_IDLE_IO2_OUT        = XX_MSK_SQI_CFG_IDLE_IO2_OUT_XX,
    SRT_SQI_CFG_IDLE_IO2_OUT        = XX_SRT_SQI_CFG_IDLE_IO2_OUT_XX,
    MSK_SQI_CFG_IDLE_IO3_OE         = XX_MSK_SQI_CFG_IDLE_IO3_OE_XX,
    SRT_SQI_CFG_IDLE_IO3_OE         = XX_SRT_SQI_CFG_IDLE_IO3_OE_XX,
    MSK_SQI_CFG_IDLE_IO3_OUT        = XX_MSK_SQI_CFG_IDLE_IO3_OUT_XX,
    SRT_SQI_CFG_IDLE_IO3_OUT        = XX_SRT_SQI_CFG_IDLE_IO3_OUT_XX
  }


  self.SPI_MACRO_MAX_SIZE              = XX_SPI_MACRO_MAX_SIZE_XX
...
function SpiFlashMacroTest:spi_configuration_set_mode(atSpiConfiguration, ucMode)
  ...
  if tResult~=true then
    tLog.error('Invalid mode specified: %s. Accepted values are %s.', tostring(ucMode), table.concat(atValid, ', '))
  else
